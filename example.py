...
#COMMENT FOR TASK
# overall this version doesnt seem to perform as well as in the semantic.py example, perhaps a newer
# version thats been trained on more diverse data would be more beneficial for this example